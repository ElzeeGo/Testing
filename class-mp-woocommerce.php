...

{
...

    {
        ...
        <tr class="multiparcels-carrier">
            ...
            <th><?php _e('Carrier', 'multiparcels-shipping-for-woocommerce'); ?></th>

            <td><?php echo MultiParcels()->carriers->name($carrier); ?></td>
        ...
        <tr class="multiparcels-pickup-location">
            ...
            <th><?php _e('Pickup location', 'multiparcels-shipping-for-woocommerce'); ?></th>

            <td><?php echo sprintf('%s, %s, %s', $location['name'], $location['address'], $location['city']); ?></td>
